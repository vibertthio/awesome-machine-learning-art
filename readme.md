...
- [neural-style-pt](https://github.com/ProGamerGov/neural-style-pt) - A PyTorch style transfer implementation. Easy to install, runs on all operating systems, has extensive wiki guides, companion scripts, and other neural models.
